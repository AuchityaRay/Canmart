...
<div className="flex">
      ...
      <div className="container mx-auto p-4 ">
        <h1 className="text-2xl font-bold mb-4 text-left">Add Product</h1>
        ...
        <div className="bg-white h-2/5">
          <div className="flex my-10 mx-auto w-[95%] ">
            ...
            <div className="w-1/3 px-4">
              ...
              >
                <option defaultValue={true} hidden>Select Category</option>
          ...
          <div className="flex my-10 mx-auto  w-[95%] ">
            ...
            <div className="w-1/3 pl-4">
              ...
              >
                <option defaultValue={true} hidden>Select Parent Category</option>
                {/* Add your product categories here as <option> elements */}
                {
          ...
          <div className="flex justify-end w-[97%]">
            <button className="bg-black text-white py-2 px-4 w-32 rounded-full" onClick={handleAddProduct}>
              Add
            </button>
          </div>
        </div>
